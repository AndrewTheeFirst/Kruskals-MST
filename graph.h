...
class Graph {
    ...
    /** Allows a fast O(1) lookup of a vertex number given its label */
    std::unordered_map<std::string, size_t> label_to_vertex_map;

    /** Allows a fast O(1) lookup of a vertex label given its number */
